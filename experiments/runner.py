"""DEPRECATED: Use new_runner.py for structured paper outputs (results_v2/).

This grid-search runner is retained because the Streamlit display layer
reads from experiments/results/ which was generated by this runner.
